...
TEST_CASE_TEMPLATE("bench random insert erase" * doctest::test_suite("bench"), Map, robin_hood::unordered_flat_map<int, int>, robin_hood::unordered_node_map<int, int>, robin_hood::unordered_flat_map<uint64_t, uint64_t>, robin_hood::unordered_node_map<uint64_t, uint64_t>) {
    sfc64 rng(123);
